 ...
 */
'use strict';
angular.module('projectPedidosApp').factory('Auth',
  ...
  //medodo que codifica usuario y contraseña en la cabezera
  .factory('Base64', function () {
    ...
    return {
      ...
      decode: function (input) {
        ...
        // remover todos los caracteres que no son A-Z, a-z, 0-9, +, /, or =
